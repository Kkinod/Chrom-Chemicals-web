export const labels = {
    ...
    sectionOffers: {
        ...
        firtstCard: {
            ...
            secondDescription: 'propan (bezwonny)',
            thirdDescription: 'n-butan (bezwonny)',
            fourthDescription: 'mieszanki aerozolowe 2 i 3 składnikowe (bezwonne)',
            fifthDecription: 'gaz LPG',
        },
        secondCard: {
            heading: 'Chemia',
            toluen: 'toluen',
            ...
            fourthDescription: 'benzyny specjalne',
            fifthDecription: 'DME',
        },
        thirdCard: {
